    ...
    <main className="py-20 md:py-24">
      ...
      <Shell className="mt-20">
        ...
        <div className="overflow-hidden rounded-xl border border-bms-divider shadow-sm h-[450px] relative">
          <iframe 
            src="https://maps.google.com/maps?q=-6.2561118,107.0852704+(PT.+MANDIRI+DELTA+TEKNIK)&t=&z=16&ie=UTF8&iwloc=B&output=embed"
            width="100%" 
            height="100%" 
            style={{ border: 0 }} 
            allowFullScreen 
        ...
        <div className="mt-4 text-right">
          <a 
            href="https://www.google.com/maps/place/PT.+MANDIRI+DELTA+TEKNIK/@-6.2561065,107.0826955,1118m/data=!3m2!1e3!4b1!4m6!3m5!1s0x2e698f66991a75fb:0x2e7457eca8b678!8m2!3d-6.2561118!4d107.0852704!16s%2Fg%2F11n3prx2fh?entry=ttu&g_ep=EgoyMDI2MDQyMi4wIKXMDSoASAFQAw%3D%3D" 
            target="_blank" 
